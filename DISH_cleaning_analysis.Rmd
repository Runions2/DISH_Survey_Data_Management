...
df.survey_full <- read_excel( "/Users/ricki/Desktop/DISH_data_cleaning/Data/Initial_survey_05.08.24.xlsx")
df.intake24_full <- read_excel( "/Users/ricki/Desktop/DISH_data_cleaning/Data/intake24_05.08.24.xlsx")
```
...
#Remove NA values in name - likely not needed
df.survey <- df.survey %>% 
  filter(!is.na(UserID))
...
df.survey <- df.survey %>%
  mutate(Sex = case_when(
    UserID %in% c( 10008296, 20002338)  ~ "Prefer not to say", 
    TRUE ~ Sex
  ))
...
##Remove age-ineligible participants from intake24
...
#Keep only the participants that are between 2-15 years old
df.intake24 <- df.intake24[which(df.intake24$CalcAge>2 & df.intake24$CalcAge<16),]
...
Intake24 - issue here with ethnicity
...
#export for review
write.xlsx(subset_AgreeOSG_Other, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output/Other_response_OSG_200824.xlsx")
write.xlsx(subset_ImportanceED_Other, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output/Other_response_ED_200824.xlsx")
...
write.xlsx(df.intake24_missing_food, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output/Missing_Food_Codes_200824.xlsx")
...
# Remove a response if deemed incomplete

#        df.intake24_removed <- df.intake24 %>%
#          filter(UserID != "fss7")
#
# check removed codes
#       df.intake24_Under5Foods_removed <- df.intake24 %>%
#          filter(UserID = "fss7")
...
write.csv(df.intake24, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output/intake24_clean_for_management_200824.csv")
write.csv(df.survey, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output/survey_clean_for_management_200824.csv")
write.csv(user_char, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output/user_characteristics_200824.csv")
