...
# Import the data
```{r include=FALSE}
df.intake24_item <- read.csv( "/Users/ricki/Desktop/DISH_data_cleaning/Output/intake24_item_090924.csv") 
df.survey <- read.csv( "/Users/ricki/Desktop/DISH_data_cleaning/Output/survey_clean_090924.csv") 
df.char <- read.csv( "/Users/ricki/Desktop/DISH_data_cleaning/Output/participant_characteristics_090924.csv") 
...
df.intake24_item <- df.intake24_item %>%
  filter(!UserID == 10006095 & RecallNo %in% c(1,2)) 
...
#fix number of recalls variable
df.intake24_item <- df.intake24_item %>%
  mutate(NumberOfRecalls = ifelse(UserID == 10000459, 2, NumberOfRecalls))
...
foodgrid_onerecall <- expand.grid( #create a grid of each combination of the below:
  ...
  MainFoodGroupCode = factor(1:66)) #create a column of with 1-61 for reporting food groups
...
write.csv(df.intake24_participant, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_participant_090924.csv")
write.csv(df.intake24_recall, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_recall_090924.csv")
write.csv(df.intake24_item, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_item_090924.csv")
write.csv(df.survey, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/survey_090924.csv")

write.csv(df.intake24_recall_ndns_fg, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_ndns_food_groups_090924.csv")

write.csv(df.intake24_participant_ndns_fg_wide, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_ndns_food_groups_WIDE_090924.csv")

write.csv(df.intake24_recall_discretionary_fg, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_discretionary_food_groups_090924.csv")

write.csv(df.intake24_participant_discretionary_fg_wide, file = "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_discretionary_food_groups_WIDE_090924.csv") 
