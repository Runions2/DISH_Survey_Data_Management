...
test<- df.intake24_participant %>%
  select(UserID, Age, Sex, UI_Energykcal, UI_EAR_prct_Energy, UI_EAR_TEST)

df.intake24_participant <- df.intake24_participant %>%
  mutate(UI_EAR_TEST = case_when(Sex == "Male" & Age >= 2 & Age <= 3 ~ (UI_Energykcal/1088)*100,
                                        Sex == "Male" & Age >= 4 & Age <= 6 ~ (UI_Energykcal/1482)*100,
                                        Sex == "Male" & Age >= 7 & Age <= 10 ~ (UI_Energykcal/1817)*100,
                                        Sex == "Male" & Age >= 11 & Age <= 14 ~ (UI_Energykcal/2500)*100,
                                        Sex == "Male" & Age >= 15 & Age <= 18 ~ (UI_Energykcal/2500)*100,
                                        
                                        Sex == "Female" & Age >= 1 & Age <= 3 ~ (UI_Energykcal/1004)*100,
                                        Sex == "Female" & Age >= 4 & Age <= 6 ~ (UI_Energykcal/1378)*100,
                                        Sex == "Female" & Age >= 7 & Age <= 10 ~ (UI_Energykcal/1703)*100,
                                        Sex == "Female" & Age >= 11 & Age <= 14 ~ (UI_Energykcal/2000)*100,
                                        Sex == "Female" & Age >= 15 & Age <= 18 ~ (UI_Energykcal/2000)*100,
                                        
                                        TRUE ~ NA_real_)) %>%
  relocate(UI_EAR_TEST, .before = UI_Energykcal)
