...
# Import the data
```{r include=FALSE}
  #df.intake24_item <- read.csv( "/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_item_280824.csv") 
  #df.intake24_participant <- read.csv("/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_participant_280824.csv") 
  #df.intake24_recall <- read.csv("/Users/ricki/Desktop/DISH_data_cleaning/Output_data_analysis/intake24_recall_280824.csv")
  #df.survey <- read.csv( "/Users/ricki/Desktop/DISH_data_cleaning/Output/survey_clean_280824.csv") 
  #df.weights_full <- read.csv("/Users/ricki/Desktop/DISH_data_cleaning/Data/survey_weights_140824.csv") 
...
save_as_docx(table.demo, 
             path = paste0("C:/Users/ljaacks/OneDrive - University of Edinburgh/Scottish Diets/_National Monitoring of Diet Scotland/3_DISH/Analysis/Output/","Table_Demographics_",format(Sys.time(),"%d%m%Y"),".docx"))
...
table.forfigure.sdgs.sex <- tbl_svysummary(
  ...
  bold_labels() %>% 
  as_flex_table()
save_as_docx("SDG by Sex Table for Figure"=table.forfigure.sdgs.sex,
             path = paste0("C:/Users/ljaacks/OneDrive - University of Edinburgh/Scottish Diets/_National Monitoring of Diet Scotland/3_DISH/Analysis/Output/","FigureTables_SDG_Sex_",format(Sys.time(),"%d%m%Y"),".docx"))
...
table.forfigure.sdgs.simd <- tbl_svysummary(
  ...
  bold_labels() %>% 
  as_flex_table()
save_as_docx("SDG by SIMD Table for Figure"=table.forfigure.sdgs.simd,
             path = paste0("C:/Users/ljaacks/OneDrive - University of Edinburgh/Scottish Diets/_National Monitoring of Diet Scotland/3_DISH/Analysis/Output/","FigureTables_SDG_SIMD_",format(Sys.time(),"%d%m%Y"),".docx"))
...
save_as_docx("Overall"=table.sdgs, "by Age"=table.sdgs.age, "by Sex"=table.sdgs.sex, "by SIMD"=table.sdgs.simd,
             path = paste0("C:/Users/ljaacks/OneDrive - University of Edinburgh/Scottish Diets/_National Monitoring of Diet Scotland/3_DISH/Analysis/Output/","Table_SDGs_",format(Sys.time(),"%d%m%Y"),".docx"))
```
...
save_as_docx("Mean portions"=table.sdgs.vegfruit,
             path = paste0("C:/Users/ljaacks/OneDrive - University of Edinburgh/Scottish Diets/_National Monitoring of Diet Scotland/3_DISH/Analysis/Output/","Table_F&V_",format(Sys.time(),"%d%m%Y"),".docx"))
```
...
table.rnis.age <- tbl_svysummary(
  ...
  label = c(Avg_VitaminAug ~ "Vitamin A (µg/day)",
            RNI_VitaminA ~ "Vitamin A, % above RNI",
            LRNI_VitaminA ~ "Vitamin A, % above LRNI",
            RNI_prct_VitaminA ~ "Vitamin A, % RNI",
            Avg_Riboflavinmg ~ "Riboflavin (mg/day)",
            RNI_Riboflavin ~ "Riboflavin, % above RNI",
            LRNI_Riboflavin ~ "Riboflavin, % above LRNI",
            RNI_prct_Riboflavin ~ "Riboflavin, % RNI",
            Avg_Folateug ~ "Folate (µg/day)",
            RNI_Folate ~ "Folate, % above RNI",
            LRNI_Folate ~ "Folate, % above LRNI",
            RNI_prct_Folate ~ "Folate, % RNI",
            Avg_VitaminDug ~ "Vitamin D (µg/day)",
            RNI_VitaminD ~ "Vitamin D, % above RNI",
            RNI_prct_VitaminD ~ "Vitamin D, % RNI",
            Avg_Ironmg ~ "Iron (mg/day)",
            RNI_Iron ~ "Iron, % above RNI",
            LRNI_Iron ~ "Iron, % above LRNI",
            RNI_prct_Iron ~ "Iron, % RNI",
            Avg_Calciummg ~ "Calcium (mg/day)",
            RNI_Calcium ~ "Calcium, % above RNI",
            LRNI_Calcium ~ "Calcium, % above LRNI",
            RNI_prct_Calcium ~ "Calcium, % RNI",
            Avg_Magnesiummg ~ "Magnesium (mg/day)",
            RNI_Magnesium ~ "Magnesium, % above RNI",
            LRNI_Magnesium ~ "Magnesium, % above LRNI",
            RNI_prct_Magnesium ~ "Magnesium, % RNI",
            Avg_Potassiummg ~ "Potassium (mg/day)",
            RNI_Potassium ~ "Potassium, % above RNI",
            LRNI_Potassium ~ "Potassium, % above LRNI",
            RNI_prct_Potassium ~ "Potassium, % RNI",
            Avg_Iodineug ~ "Iodine (µg/day)",
            RNI_Iodine ~ "Iodine, % above RNI",
            LRNI_Iodine ~ "Iodine, % above LRNI",
            RNI_prct_Iodine ~ "Iodine, % RNI",
            Avg_Seleniumug ~ "Selenium (µg/day)",
            RNI_Selenium ~ "Selenium, % above RNI",
            LRNI_Selenium ~ "Selenium, % above LRNI",
            RNI_prct_Selenium ~ "Selenium, % RNI",
            Avg_Zincmg ~ "Zinc (mg/day)",
            RNI_Zinc ~ "Zinc, % above RNI",
            LRNI_Zinc ~ "Zinc, % above LRNI",
...
table.rnis.slide1 <- tbl_svysummary(
  ...
  missing = "ifany",
  include = c(Avg_VitaminAug, Avg_Riboflavinmg, Avg_Folateug, Avg_VitaminDug, Avg_Ironmg, Avg_Calciummg, 
...
table.rnis.slide2 <- tbl_svysummary(
  ...
  statistic = list(all_continuous() ~ "{mean}"),
  missing = "ifany",
  include = c(RNI_prct_VitaminA, RNI_prct_Riboflavin, RNI_prct_Folate, RNI_prct_VitaminD,RNI_prct_Iron, RNI_prct_Calcium,
              RNI_prct_Magnesium, RNI_prct_Potassium, RNI_prct_Iodine, RNI_prct_Selenium, RNI_prct_Zinc)) %>%
  bold_labels() %>% 
  as_flex_table()

save_as_docx("Mean"=table.rnis.slide1,"Mean % RNI"=table.rnis.slide2,
             path = paste0("C:/Users/ljaacks/OneDrive - University of Edinburgh/Scottish Diets/_National Monitoring of Diet Scotland/3_DISH/Analysis/Output/","Table_RNIs&LRNIs_Slides_",format(Sys.time(),"%d%m%Y"),".docx"))
```
